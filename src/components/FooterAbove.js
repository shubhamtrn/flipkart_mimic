...
function FooterAbove() {
  return (
    <>
          <div className="description" style={{ color: "#878787" }}>
        <br />
        <div
          style={{
            float: "left",
        ...
        <div style={{ float: "left", width: "150px", height: "12px" }}>
        ...
        >
          <p>MOST SEARCHED FOR ON FLIPKART:</p>
        </div>
        <p
          style={{ fontSize: "13px", marginLeft: "25px", marginRight: "25px" }}
        >
          Bounce Infinity E1 | Google Pixel 6 | Avivo T1X | OPPO Reno8 5G | OPPO
          Reno8 Pro 5G | Nothing Phone 1 | Sell Old Mobile Phones | ASUS TUF
          Gaming F15 Core i5 10th Gen | Electronics Store | OPPO A16K | Vivo
          Y33T | OPPO Reno7 5G | Bathroom Exhaust Fan | Samsung Window AC | OPPO
          Reno7 Pro 5G | iPhone 13 | iPhone 13 Pro | iPhone 13 Pro Max | iPhone
          13 Mini | Google Pixel 6a covers | Flipkart QuickBooks | Flipkart Help
          Centre | Online Boat Store | Flipkart Track Orders | Flipkart Manage
          Orders | Flipkart Return Orders | Flipkart Gift Cards Store | Flipkart
          Axis Bank Credit Card | Flipkart Pay Later
          <br />
          <br />
          <p
            style={{
          ...
          iPhone 11 | iPhone 11 Pro | iPhone 11 Pro Max | Mobile Offers | iphone
          x4G Mobile | Nokia Mobile | Samsung Mobile | iphoneOppo Mobile | Vivo
          Mobile
          <br />
          <br />
          <p
          ...
          GoPro Action Camera | Nikon Camera | Canon Camera | Sony Camera |
          ...
          MacBook Pro M2 | acer Ryzen 3 Dual Core 3250U - (8 GB/256 GB
          SSD/Windows 11 Home) Z2-493 Thin and Light Laptop | ASUS Vivobook S14
          OLED (2022) | ASUS Zenbook 14 OLED (2022) | Realme Book Prime Core i5
          11th Gen | Microsoft Surface Go Pentium 128GB | Branded Laptops |
          Apple LaptopsAcer Laptops | Lenovo Laptops | Dell Laptops | Asus
          Laptops | HP Laptops | Gaming Laptops2 in 1 Laptops | Laptops | Dell
          latest laptops 2022HP latest laptops 2022 | Infinix INBook X1 Neo
          Series Celeron Quad Core - (8 GB/256 GB SSD/Windows 11 Home) XL22 Thin
          and Light Laptop | Microsoft Laptops | 12th Gen Intel Core Laptops
          <br />
        </p>
        <br />
        <br />
        ...
        <div
          ...
          style={{ color: "gray", margin: "0px 25px" }}
        >
